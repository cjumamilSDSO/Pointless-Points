  ...
  <div class="podium-card">
    <div class="podium-container">
      <div v-if="users.length >= 3" class="podium">
            ...
            :style="{
              ...
              background: getTopThree(users)[1].color
                ? `linear-gradient(180deg, ${
                  ...
                  }CC 0%, ${getTopThree(users)[1].color}66 100%)`
        ...
        <!-- First Place -->
        <div class="podium-item">
          <v-avatar size="64" :color="getTopThree(users)[0].color || 'amber'">
            ...
            :style="{
              ...
              background: getTopThree(users)[0].color
                ? `linear-gradient(180deg, ${
                  ...
                  }CC 0%, ${getTopThree(users)[0].color}66 100%)`
            ...
            :style="{
              ...
              background: getTopThree(users)[2].color
                ? `linear-gradient(180deg, ${
                  ...
                  }CC 0%, ${getTopThree(users)[2].color}66 100%)`
